...
$filters = [
    ...
    'limit'     => $_GET['limit'] ?? '100' // Default to 100 limit
];

// Fetch all logs submitted by this user
$logs = getWasteLogs($conn, 'All', $filters, $_SESSION['username']);
?>
<?php
...
<div class="dashboard-wrapper">
    ...
    <main class="main-content">
        ...
        <div class="d-flex justify-content-between align-items-end mb-4">
            <div>
                <h1 class="page-title" style="font-size: 3.2rem; letter-spacing: -1px;">My Submissions</h1>
                <p class="page-subtitle text-muted mt-1">Track the status of your submitted production waste entries.</p>
            </div>
            <div class="d-flex align-items-center gap-3 pb-2">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end shadow border-0 mt-2 p-4" style="border-radius: 16px; min-width: 320px; animation: fadeIn 0.2s ease-in-out;">
                        <h6 class="fw-bold mb-3" style="color: #181a1f;">Filter Options</h6>
                        <form method="GET" action="submissions.php">
                            <div class="row mb-3">
                                <div class="col-6">
                                    <label class="form-label" style="font-size: 0.8rem; text-transform: uppercase;">Start Date</label>
                                    <input type="date" class="form-control" name="startDate" value="<?= htmlspecialchars($filters['startDate']) ?>">
                                </div>
                                <div class="col-6">
                                    <label class="form-label" style="font-size: 0.8rem; text-transform: uppercase;">End Date</label>
                                    <input type="date" class="form-control" name="endDate" value="<?= htmlspecialchars($filters['endDate']) ?>">
                                </div>
                            </div>

                            <div class="mb-4">
                                <label class="form-label" style="font-size: 0.8rem; text-transform: uppercase;">Show Entries</label>
                            ...
                            <div class="d-flex gap-2">
                                <a href="submissions.php" class="btn btn-light w-50 py-2 d-flex align-items-center justify-content-center gap-2" style="font-size: 0.9rem; border-radius: 12px; border: 1px solid #e2e8f0; color: #64748b;">
        ...
        <div class="data-card position-relative text-start shadow-sm flex-grow-1 d-flex flex-column" style="border-radius: 30px; border: 1px solid rgba(0,0,0,0.03); background: #ffffff; padding: 40px;">
            <div class="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom border-light">
                ...
                <div>
                    <h3 class="fs-5 fw-bold mb-0" style="color: #181a1f;">My Logs Archive</h3>
                    <div class="text-muted" style="font-size: 0.85rem;">Review all your reported waste and their current status</div>
                </div>
            </div>
